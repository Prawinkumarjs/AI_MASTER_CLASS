...
haar_file = 'D:\\AI_MASTER_CLASS\\day 7\\haarcascade_frontalface_default.xml'
face_cascade = cv2.CascadeClassifier(haar_file) #loading face detector
datasets = 'D:\\AI_MASTER_CLASS\\day 7\\datasets'
...
#model = cv2.face_LBPHFaceRecognizer.create() #loading face recognizer
