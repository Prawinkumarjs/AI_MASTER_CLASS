...
while True:  # infinite loop
    ...
    threshImg = cv2.threshold(imgDiff, 25, 255, cv2.THRESH_BINARY)[1]  # detected region will be converted
    #                                                                              # into binary
